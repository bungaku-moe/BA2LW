...
namespace BA2LW.Core
{
    ...
    public class MainControl : MonoBehaviour
    {
        ...
        IEnumerator Start()
        {
            ...
            string settingPath = Path.Combine(dataFolderPath, "settings.json");
            ...
            SpineAtlasAsset SprAtlasAsset = SpineAtlasAsset.CreateRuntimeInstance(atlasTextAsset, textures, Shader.Find("BA2LW/Skeleton Straight Alpha"), true);
            ...
            SkeletonDataAsset sprSkeletonDataAsset = SpineHelper.CreateSkeletonDataAsset(skeletonData, stateData);
            ...
            if (setting.bg.isSpine)
            {
                ...
                SpineAtlasAsset bgAtlasAsset = SpineAtlasAsset.CreateRuntimeInstance(bgAtlasTextAsset, bgTextures, Shader.Find("BA2LW/Skeleton Straight Alpha"), true);
                ...
                SkeletonData bgSkeletonData = bgBinary.ReadSkeletonData(setting.bg.name);
                AnimationStateData bgStateData = new AnimationStateData(bgSkeletonData);
                SkeletonDataAsset bgSkeletonDataAsset = SpineHelper.CreateSkeletonDataAsset(bgSkeletonData, bgStateData);
